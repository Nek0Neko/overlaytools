...
namespace app {
	...
	enum : uint8_t {
		...
		WEBAPI_ITEM_AMP = 0x80,
		WEBAPI_ITEM_AMP_INFINITE_AMMO,
		WEBAPI_ITEM_AMP_BOTTOMLESS_BATTERIES,
		WEBAPI_ITEM_AMP_OVER_ARMOR,
		WEBAPI_ITEM_AMP_HEAL_OVERFLOW,
		WEBAPI_ITEM_AMP_POWER_BOOSTER,
	};

	enum : uint8_t {
		WEBAPI_ITEM_AMP_TYPE_NONE = 0x0,
		WEBAPI_ITEM_AMP_TYPE_INFINITE_AMMO,
		WEBAPI_ITEM_AMP_TYPE_BOTTOMLESS_BATTERIES,
		WEBAPI_ITEM_AMP_TYPE_OVER_ARMOR,
		WEBAPI_ITEM_AMP_TYPE_HEAL_OVERFLOW,
